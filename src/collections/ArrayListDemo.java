...
public class ArrayListDemo {
	...
	public static void main(String[] args) {
		...
		// When an Item is removed from the beginning or from the middle of an
		// arrayList, java reallocate/re-index elements which will take time and is memory
		// consuming. Hence Linked list must be used in such cases.
		cars.remove(size - 1);
